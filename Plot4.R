...
legend("topright",legend=c("Submetering_1","Submetering_2","Submetering_3"), col=c("blue","red","black"),ncol=1,
       lty=c(1,1,1),cex=.4)
plot(x=data.timerange$fulldate,
     y=data.timerange$Global_reactive_power,
     type="S",
     xlab = "datetime",
